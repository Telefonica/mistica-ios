...
struct VivoColors: MisticaColors {
    ...
    let backgroundBrand = MisticaColorStyle.color(VivoColors.palette.vivoPurple | VivoColors.palette.darkModeBlack)
    ...
    let backgroundContainerBrand = MisticaColorStyle.color(VivoColors.palette.vivoPurple | VivoColors.palette.darkModeGrey)
