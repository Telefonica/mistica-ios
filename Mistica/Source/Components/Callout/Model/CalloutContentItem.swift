...
/// The texts of a Callout are distributed with a vertical spacing after each text.
///
/// Implementing the Callout layout using a UIStackView is complex because the UIStackView only allows
...
@dynamicMemberLookup
class CalloutContentItem<Element: UIView>: UIStackView {
