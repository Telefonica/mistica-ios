...
public extension Button.Style {
    ...
    private static var regularFont: UIFont { .textPreset6(.medium) }
    private static var smallFont: UIFont { .textPreset7(.medium) }
    private static var linkFont: UIFont { .textPreset7(.medium) }
