...
/// The texts of a Empty State are distributed with a vertical spacing after each text.
///
/// Implementing the Empty State layout using a UIStackView is complex because the UIStackView only allows
...
@dynamicMemberLookup
class EmptyStateContentItem<Element: UIView>: UIStackView {
