...
#### Using the terminal
* `make setup`: Needed to install the required dependencies.
* `arch -x86_64 make test`: Adding `arch -x86_64` will force to be executed as an Intel architecture so you will able to execute/record tests as Jenkins does.
#### Using XCode
* Go to /Applications
