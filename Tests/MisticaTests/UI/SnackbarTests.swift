...
final class SnackbarTests: XCTestCase {
    private let testText = "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua."
    ...
    func testInfoSnackbar() {
        verifySnackbar(style: .info)
    }

    func testInfoSnackbarWithShortActionTitle() {
        verifySnackbar(style: .info, actionTitle: "Nostrud")
    }

    func testInfoSnackbarWithLongActionTitle() {
        verifySnackbar(style: .info, actionTitle: "Excepteur sint occaecat cupidatat")
    }

    func testCriticalSnackbar() {
        verifySnackbar(style: .critical)
    }

    func testCriticalSnackbarWithShortActionTitle() {
        verifySnackbar(style: .critical, actionTitle: "Nostrud")
    }

    func testCriticalSnackbarWithLongActionTitle() {
        verifySnackbar(style: .critical, actionTitle: "Excepteur sint occaecat cupidatat")
    }

    private func verifySnackbar(style: SnackbarStyle, actionTitle: String? = nil) {
        assertSnapshot(
            for: [BrandStyle.movistar],
            and: [.light],
            as: .image(on: .iPhoneSe),
            viewBuilder: makeSnackbar(withText: testText, actionTitle: actionTitle, style: style)
        )
    }
}
