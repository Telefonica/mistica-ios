...
struct BlauColors: MisticaColors {
	...
	let backgroundContainerHover = BlauColors.palette.grey0 | BlauColors.palette.darkModeGrey7
	let backgroundContainerPressed = BlauColors.palette.grey1 | BlauColors.palette.darkModeGrey8
	let backgroundContainerBrand = BlauColors.palette.blauBluePrimary | BlauColors.palette.darkModeGrey
	let backgroundContainerBrandHover = BlauColors.palette.blauBluePrimary60 | BlauColors.palette.darkModeGrey7
	let backgroundContainerBrandPressed = BlauColors.palette.blauBluePrimary70 | BlauColors.palette.darkModeGrey8
	let backgroundContainerBrandOverInverse = BlauColors.palette.blauBlueSecondary | BlauColors.palette.darkModeGrey
	let backgroundContainerBrandOverInverseHover = BlauColors.palette.blauBlueSecondary50 | BlauColors.palette.darkModeGrey7
	let backgroundContainerBrandOverInversePressed = BlauColors.palette.blauBlueSecondary60 | BlauColors.palette.darkModeGrey8
	let backgroundContainerAlternative = BlauColors.palette.blauBluePrimary20 | BlauColors.palette.darkModeGrey
	let backgroundContainerAlternativeHover = BlauColors.palette.grey5.withAlphaComponent(0.1) | BlauColors.palette.darkModeGrey7
	let backgroundContainerAlternativePressed = BlauColors.palette.grey5.withAlphaComponent(0.2) | BlauColors.palette.darkModeGrey8
	...
	let backgroundSkeleton = BlauColors.palette.grey2 | BlauColors.palette.darkModeGrey6
	let backgroundSkeletonInverse = BlauColors.palette.blauBlueSecondary | BlauColors.palette.darkModeGrey6
...
public struct BlauColorPalette {
	...
	public let blauBluePrimary60 = UIColor(hex:"#00A2D6")!
	public let blauBluePrimary70 = UIColor(hex:"#008FBD")!
	...
	public let blauBlueSecondary50 = UIColor(hex:"#0066AD")!
	...
	public let grey0 = UIColor(hex:"#F6FCFE")!
