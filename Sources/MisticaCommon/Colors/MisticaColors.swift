...
public protocol MisticaColors {
  ...
  var backgroundContainerBrandOverInverseHover: UIColor { get }

  var backgroundContainerBrandOverInversePressed: UIColor { get }

  var backgroundContainerAlternative: UIColor { get }

  var backgroundContainerAlternativeHover: UIColor { get }

  var backgroundContainerAlternativePressed: UIColor { get }
