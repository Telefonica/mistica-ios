...
struct MovistarColors: MisticaColors {
    ...
    let backgroundBrand = MisticaColorStyle.color(MovistarColors.palette.movistarBlue | MovistarColors.palette.darkModeBlack)
    ...
    let backgroundContainerHover = MovistarColors.palette.darkModeBlack.withAlphaComponent(0.03) | MovistarColors.palette.white.withAlphaComponent(0.03)

    let backgroundContainerPressed = MovistarColors.palette.darkModeBlack.withAlphaComponent(0.05) | MovistarColors.palette.white.withAlphaComponent(0.05)

    let backgroundContainerBrand = MisticaColorStyle.color(MovistarColors.palette.movistarBlue | MovistarColors.palette.darkModeGrey)

    let backgroundContainerBrandHover = MovistarColors.palette.darkModeBlack.withAlphaComponent(0.1) | MovistarColors.palette.white.withAlphaComponent(0.03)

    let backgroundContainerBrandPressed = MovistarColors.palette.darkModeBlack.withAlphaComponent(0.2) | MovistarColors.palette.white.withAlphaComponent(0.05)
    ...
    let coverBackgroundHover = MovistarColors.palette.darkModeBlack.withAlphaComponent(0.25)

    let coverBackgroundPressed = MovistarColors.palette.darkModeBlack.withAlphaComponent(0.35)
    ...
    let tagTextPromo = MovistarColors.palette.purple70 | MovistarColors.palette.purple40

    let tagTextActive = MovistarColors.palette.movistarBlue

    let tagTextInactive = MovistarColors.palette.grey5 | MovistarColors.palette.darkModeGrey5
    ...
    let tagTextError = MovistarColors.palette.pepper70 | MovistarColors.palette.pepper40

    let tagBackgroundPromo = MovistarColors.palette.purple10 | MovistarColors.palette.movistarBlueDark

    let tagBackgroundActive = MovistarColors.palette.movistarBlue10 | MovistarColors.palette.movistarBlueDark

    let tagBackgroundInactive = MovistarColors.palette.grey1 | MovistarColors.palette.movistarBlueDark

    let tagBackgroundSuccess = MovistarColors.palette.movistarGreen10 | MovistarColors.palette.movistarBlueDark

    let tagBackgroundWarning = MovistarColors.palette.egg10 | MovistarColors.palette.movistarBlueDark

    let tagBackgroundError = MovistarColors.palette.pepper10 | MovistarColors.palette.movistarBlueDark
}
