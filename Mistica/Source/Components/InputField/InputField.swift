...
public class InputField: UIView {
    ...
    private lazy var backingPlaceholderLabel: UILabel = {
        ...
        label.font = .preset1(weight: .regular)
    ...
    private lazy var placeholderLayer: CATextLayer = {
        ...
        textLayer.font = UIFont.preset3(weight: .regular)
        textLayer.fontSize = UIFont.preset3(weight: .regular).pointSize
    ...
    private func textInputView(with style: TextInputStyle) -> TextInputView {
        ...
        textInputView.font = .preset3(weight: .regular)
...
private extension InputField {
    ...
    func updatePlaceholderLayerPosition() {
        if isPlaceholderFloating {
            ...
            placeholderLayer.fontSize = UIFont.preset1(weight: .regular).pointSize
        } else {
            ...
            placeholderLayer.fontSize = UIFont.preset3(weight: .regular).pointSize
        }
    }
