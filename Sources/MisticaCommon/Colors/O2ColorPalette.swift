...
struct O2Colors: MisticaColors {
	...
	let backgroundContainerHover = O2Colors.palette.grey0 | O2Colors.palette.darkModeGrey7
	let backgroundContainerPressed = O2Colors.palette.grey1 | O2Colors.palette.darkModeGrey8
	let backgroundContainerBrand = O2Colors.palette.o2BluePrimary | O2Colors.palette.darkModeGrey
	let backgroundContainerBrandHover = O2Colors.palette.o2BluePrimary60 | O2Colors.palette.darkModeGrey7
	let backgroundContainerBrandPressed = O2Colors.palette.o2BluePrimary70 | O2Colors.palette.darkModeGrey8
	let backgroundContainerBrandOverInverse = O2Colors.palette.o2BluePrimary70 | O2Colors.palette.darkModeGrey
	let backgroundContainerBrandOverInverseHover = O2Colors.palette.o2BluePrimary80 | O2Colors.palette.darkModeGrey7
	let backgroundContainerBrandOverInversePressed = O2Colors.palette.o2BluePrimary90 | O2Colors.palette.darkModeGrey8
	let backgroundContainerAlternative = O2Colors.palette.grey1 | O2Colors.palette.darkModeGrey
	let backgroundContainerAlternativeHover = O2Colors.palette.grey5.withAlphaComponent(0.1) | O2Colors.palette.darkModeGrey7
	let backgroundContainerAlternativePressed = O2Colors.palette.grey5.withAlphaComponent(0.2) | O2Colors.palette.darkModeGrey8
...
public struct O2ColorPalette {
	...
	public let o2BluePrimary60 = UIColor(hex:"#001380")!
	public let o2BluePrimary70 = UIColor(hex:"#000066")!
	public let o2BluePrimary80 = UIColor(hex:"#00004D")!
